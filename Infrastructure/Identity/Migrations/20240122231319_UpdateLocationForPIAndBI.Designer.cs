...
namespace Infrastructure.Identity.Migrations
{
    ...
    [Migration("20240122231319_UpdateLocationForPIAndBI")]
    partial class UpdateLocationForPIAndBI
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.Identity.Location", b =>
                {
                    ...
                    b.Property<int?>("BusinesslInfoId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.Identity.Location", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Identity.PersonalInfo", "PersonalInfo")
                        .WithOne("Location")
                        .HasForeignKey("Core.Entities.Identity.Location", "PersonalInfoId");
